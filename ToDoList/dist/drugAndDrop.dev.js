...
var bascket = document.querySelector("#bascketTrash");

var dragAndDrop = function dragAndDrop() {
  var elForRemove = document.querySelectorAll(".new_elem_li"); // function dragStart(event, index) {
  ...
  function drop(event, index) {
    ...
    var newElement = document.querySelector(".new_elem_li");
    elForRemove.remove();
  }
